...
public class TranslatePreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new PasswordFieldEditor(APP_ID, "百度翻译的APP_ID:", getFieldEditorParent()));
		addField(new PasswordFieldEditor(SECURITY_KEY, "百度翻译的SECURITY_KEY:", getFieldEditorParent()));
		addField(new PasswordFieldEditor(YOUDAO_KEY, "有道翻译的KEY:", getFieldEditorParent()));
		addField(new PasswordFieldEditor(YOUDAO_KEYFROM, "有道翻译的KEYFROM:", getFieldEditorParent()));
